 ...
 * @author Brain
 */
public class FrmFournisseur extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFournisseur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
